...
public abstract class Figure
{
    ...
    private int x;                  // the x location of the upper left corner of the figure bounding rectangle in pixels
    private int y;                  // the y location of the upper left corner of the figure bounding rectangle in pixels
